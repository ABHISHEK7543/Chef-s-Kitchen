  ...
  return (
    ...
    <>    <div className='relative'>
      ...
      <div className='absolute bottom-38 left-12 '>
        <h1 className='textonpic text-6xl text-white font-bold mb-8'>We are a team made<br/>
             up a profficnal<br/>
             chefs,kitchen & <br/>
             newbies
        </h1>
        <Link className='picbotton py-4 px-10 rounded-full bg-white text-black active:bg-green-300' to="/recipes">view to recipes</Link>
